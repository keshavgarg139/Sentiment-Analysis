...
setwd("M:/MBA/BIM_BusinessAnalytics/Sentiment Analysis")
...
files <- list.files("M:/MBA/BIM_BusinessAnalytics/Sentiment Analysis/data/")

#----
# combine the path to the file & 1st file
fileName <- glue("M:/MBA/BIM_BusinessAnalytics/Sentiment Analysis/data/", files[1], sep = " ")
#----
...
GetSentiment <- function(file){
  # get the file
  fileName <- glue("M:/MBA/BIM_BusinessAnalytics/Sentiment Analysis/data/", file, sep = " ")
...
# distinguish between Bush Sr. and George W. Bush 
